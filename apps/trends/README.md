...
- `../../deploy/trends-api/development/`: Development API 배포 단위
...
- Development API: `deploy/trends-api/development/.env.trends-api.development`
...
Development API 운영은 [배포 안내](../../deploy/trends-api/development/README.md)를 따릅니다.

Production 수집 편의 스크립트는 의도적으로 제공하지 않습니다.
