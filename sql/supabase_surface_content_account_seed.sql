-- ============================================================
-- BlogGenius Account Supporting Resource Placements
-- 대상: Supabase SQL Editor
-- 전제:
-- 1) supabase_surface_content.sql 적용 완료
-- 2) developer blog / ebook seed 적용 완료
-- ============================================================
-- 운영 정책:
-- - resource campaign만 재사용
-- - account.supporting / compact_card
-- - campaign audience에 따라 Tester / Free에만 노출
...
values
    ('developer-blog-sidebar-v1', 'account', 'supporting', 'compact_card', 100, true),
    ('oracle-cloud-guide-sidebar-v1', 'account', 'supporting', 'compact_card', 200, true)
...
where placement.surface_key = 'account'
