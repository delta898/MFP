...
test('shopping editor saves the posting targets used by the management queue', () => {
  ...
  assert.match(overlays, /id="shopping-edit-target-naver" name="shopping-edit-target" type="radio"/);
  assert.match(overlays, /id="shopping-edit-target-wordpress" name="shopping-edit-target" type="radio"/);
  ...
  assert.match(editor, /status === '발행 준비 완료' && targets\.length !== 1/);
