...
- 2026-09-08: `codex/feature/design-system-10-smart-comments`에서 스마트 댓글의 정보 hierarchy, action 상태와 async feedback을 canonical guide에 대조하는 작업을 시작했다. 세부 기록은 [스마트 댓글 개발 기록](2026-09-08-design-system-10-smart-comments-development.md)을 따른다.
