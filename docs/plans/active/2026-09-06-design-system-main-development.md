...
- 2026-09-08: `codex/feature/design-system-09-blog-queue-management`에서 글감 관리의 행별 action 의미, 정보 hierarchy, async 상태와 narrow layout을 작은 slice로 개선하기 시작했다. 세부 기록은 [글감 관리 개발 기록](2026-09-08-design-system-09-blog-queue-management-development.md)을 따른다.
